...
function wp_bootstrap_starter_scripts() {
    ...
    // load custom CSS    
    wp_enqueue_style('slick-css', get_template_directory_uri() . '/inc/assets/css/custom_css/slick.css' );
    wp_enqueue_style('slick-theme-css', get_template_directory_uri() . '/inc/assets/css/custom_css/slick-theme.css' );
    wp_enqueue_style('custom-css', get_template_directory_uri() . '/inc/assets/css/custom_css/custom.css' );
    wp_enqueue_style('awesome-styles', get_template_directory_uri() . '/inc/assets/css/custom_css/font-awesome/css/font-awesome.min.css');
...
wp_register_script( 'core-js', get_template_directory_uri() . '/inc/assets/js/custom_js/core.js');
...
?>
    ...
    <?php if ( $inner_query->have_posts() ) : while ( $inner_query->have_posts() ) : $inner_query->the_post(); ?>        
        <div class="single-post">
            ...
            <a href="<?php esc_url( the_permalink($post_ID) ); ?>" class="btn btn-go">Lorem</a>            
        </div>
...
function slider_cpt() {
    $labels = array(
        ...
        'menu_name'           => __( 'SLIDER'),
        'parent_item_colon'   => __( 'Nadrzędny element'),
        'all_items'           => __( 'Zobacz wszystkie'),
        'view_item'           => __( 'Zobacz wpis'),
        'add_new_item'        => __( 'Dodaj wpis'),
        'add_new'             => __( 'Dodaj nowy wpis'),
        'edit_item'           => __( 'Edytuj wpis'),
        'update_item'         => __( 'Zaktualizuj wpis'),
        'search_items'        => __( 'Szukaj wpis'),
        'not_found'           => __( 'Nie znaleziono'),
        'not_found_in_trash'  => __( 'Nie znaleziono'),
        'category' => __( 'kategoria')
    );
    $args = array(
        'label'               => 'slider na głównej',
        'description'         => 'Slider',
        'labels'              => $labels,
